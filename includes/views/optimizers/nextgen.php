		...
		<div class="megaoptim-middle-content">
			<?php if ( $is_profile_valid && ($tokens == -1 || $tokens > 0) ): ?>
				<div id="megaoptim-optimizer-scan" class="text-center">
					...
					<P class="megaoptim-mb-20 megaoptim-mt-20"><?php _e( sprintf( 'Click on the button below to scan your %s for unoptimized images. If images are found you will be able to optimize them by clicking Start button.', '<strong>' . __( 'NextGen Galleries', 'megaoptim-image-optimizer' ) . '</strong>' ), 'megaoptim-image-optimizer' ); ?></P>
						...
						<div class="megaoptim-row">
							<div class="megaoptim-col megaoptim-col-12">
								<div class="megaoptim-info">
									<p>
										<strong><?php _e( 'Important:', 'megaoptim-image-optimizer' ); ?></strong> <?php _e( sprintf( 'In order to keep the optimizer running, you need to keep the tab open, you can always open a %s and continue in that tab.', '<a href="' . admin_url() . '" target="_blank">new tab</a>' ), 'megaoptim-image-optimizer' ); ?>
									</p>
									<p>
					...
					<div id="megaoptim-control">
						<div class="megaoptim-row">
							<div class="megaoptim-col megaoptim-col-12 text-center">
                                ...
                                <p><a class="megaoptim-cancel-optimizer" href="<?php echo MGO_Admin_UI::get_optimizer_url(MEGAOPTIM_MODULE_NEXTGEN); ?>"><?php _e( 'Cancel', 'megaoptim-image-optimizer' ); ?></a></p>
                            </div>
                        </div>
					</div>
				</div>
