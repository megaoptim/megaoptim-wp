...
$optimized_thumbnails_normal = $optimized_thumbnails['normal'];
$optimized_thumbnails_retina = $optimized_thumbnails['retina'];
...
<div class="megaoptim-attachment-buttons">
        ...
        <div class="megaoptim-attachment-info-row megaoptim-attachment-stats" style="display: none;">
            <div class="megaoptim-attachment-thumbnail-stats">
                <table>
                    ...
                    <tbody>
		            <?php foreach ( $optimized_thumbnails_normal as $size => $thumb ): ?>
                        <tr>
                            <td><?php echo $size; ?></td>
                            <td>
                                <?php
	...
	<?php else: ?>
        <div class="megaoptim-dropdown megaoptim-optimize megaoptim-optimize-attachment" data-context="<?php echo $context; ?>" data-attachmentid="<?php echo $data->get_id(); ?>">
            ...
            <label for="optimize-<?php echo $data->get_id(); ?>" class="button-primary" data-toggle="dropdown"><?php _e( 'Optimize', 'megaoptim' ); ?></label>
            <ul>
                <li>
