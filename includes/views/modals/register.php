            ...
            <div class="megaoptim-panel-body-inner">
                ...
                <div id="megaoptim-register-form-step2" style="<?php echo $step === 2 ? 'display:block;' : 'display:none;'; ?>">
                    ...
                    <div class="megaoptim-form-success">
                        ...
                        <p><?php _e( 'Click on the confirmation button/link and you will be redirected to the dashboard from where you can copy your api key.', 'megaoptim' ); ?></p>
                        ...
                        <p><?php _e(sprintf('You can always find your API key in %s', '<a target="_blank" href="'.WP_MEGAOPTIM_DASHBOARD_URL.'">'.__('MegaOptim dashboard', 'megaoptim').'</a>'), 'megaoptim'); ?></p>
