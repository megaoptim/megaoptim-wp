<div id="megaoptim-apikey" class="text-center">
    ...
    <p><?php _e( 'It seems that you don\'t have API key set up. In order to use MegaOptim you need to obtain free API key which will give you 200 tokens per month for free.', 'megaoptim' ); ?></p>
