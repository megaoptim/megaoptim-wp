...
class MGO_LocalDirectories extends MGO_Library {
	...
	public function optimize( $attachment, $params = array() ) {
		...
		$attachment_object = new MGO_LocalFileAttachment( $attachment->path );
		 ...
		 * @since 1.0
		 *
		 * @param MGO_LocalFileAttachment $attachment_object
